...
function square(arr) {
    ...
    let square=arr.map(element => element * element);
    return square;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    ...
    let fullNames=arr.map(({firstName,lastName}) => (`${firstName} ${lastName}`))
    return fullNames;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    // write your code here
    let average=arr.map( student => {
        let sum= student.gradsList.reduce((accumulator, current) => accumulator + current, 0);
